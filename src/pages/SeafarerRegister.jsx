...
export default function SeafarerRegister() {
  const { t } = useLanguage();
  const p = t.seafarerRegisterPage;
          ...
          <form className="nj-form" onSubmit={handleSubmit}>
            <div className="nj-form-row">
              <div className="nj-form-field">
                <label className="nj-form-label">{p.fields.fullName}</label>
            ...
            <div className="nj-form-row">
              <div className="nj-form-field">
                <label className="nj-form-label">{p.fields.experience}</label>
                <input className="nj-form-input" type="number" min="0" required />
              </div>
              <div className="nj-form-field">
                <label className="nj-form-label">{p.fields.availability}</label>
                <input className="nj-form-input" type="date" required />
              </div>
            </div>
            ...
            <div className="nj-form-field">
              <label className="nj-form-label">{p.fields.certificates}</label>
              <input className="nj-form-input" type="text" />
            </div>
